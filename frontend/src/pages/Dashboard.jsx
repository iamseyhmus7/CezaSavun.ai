...
import { 
  Scale, UploadCloud, FileText, CheckCircle2, 
  Download, Sparkles, Clock, History, 
  ShieldCheck, Loader2, Home, FolderOpen, 
  Users, Calendar, Settings, Search, Bell,
  ChevronDown, Filter, MoreHorizontal, User, LogOut
} from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }} 
      exit={{ opacity: 0 }}
      className="flex h-screen bg-bg-main overflow-hidden font-inter"
    >
      
      {/* 1. LEFT SIDEBAR */}
      <aside className="w-20 bg-white border-r border-slate-200 flex flex-col items-center py-8 gap-8 shrink-0">
        <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 cursor-pointer" onClick={() => navigate('/')}>
        ...
        <div className="mt-auto flex flex-col gap-4">
          ...
          <div onClick={handleLogout} title="Çıkış Yap">
